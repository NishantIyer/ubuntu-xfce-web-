...
**Tip** If you want newer images based on [Ubuntu 20.04 LTS][docker-ubuntu] with the latest [TigerVNC][tigervnc-releases]/[noVNC][novnc-releases] versions, please check the **third generation** (G3) [nishh2609/ubuntu-vnc-xfce-g3][nishh2609-docker-ubuntu-vnc-xfce-g3], [nishh2609/ubuntu-vnc-xfce-chromium-g3][nishh2609-docker-ubuntu-vnc-xfce-chromium-g3] or [nishh2609/ubuntu-vnc-xfce-firefox-g3][nishh2609-docker-ubuntu-vnc-xfce-firefox-g3]. 

  

**Tip** Unless you need [nss_wrapper][nsswrapper], you can also use my newer image [nishh2609/xubuntu-vnc-novnc-firefox:default][nishh2609-docker-xubuntu-vnc-novnc-firefox:default], which is a streamlined version of this image ([image hierarchy][nishh2609-xubuntu-vnc-novnc-wiki-image-hierarchy]). If you also don't need [noVNC][novnc], you can use even a slimmer image [nishh2609/xubuntu-vnc-firefox:default][nishh2609-docker-xubuntu-vnc-firefox:default], which is a member of another growing family of application images ([image hierarchy][nishh2609-xubuntu-vnc-wiki-image-hierarchy]). The newer images include also **sudo** command. 
...
- [nishh2609 / live-web-os][this-docker] 

  

  - `latest` based on `nishh2609/ubuntu-vnc-xfce:latest` and the Firefox multiprocess is **enabled** (see below) 
...
The image supports the following container start-up options: `--wait` (default), `--skip`, `--debug` (also `--tail-log`) and `--help`. This functionality is inherited from the [base image][nishh2609-docker-ubuntu-vnc-xfce]. 
...
docker run --rm nishh2609 / live-web-os --help 
...
-w, --wait      (default) Keeps the UI and the vnc server up until SIGINT or SIGTERM are received. 
                ...
                example: docker run -d -P nishh2609/ubuntu-vnc-xfce 

                example: docker run -it -P --rm nishh2609/ubuntu-vnc-xfce bash 

  

-s, --skip      Skips the vnc startup and just executes the provided command. 

                example: docker run -it -P --rm nishh2609/ubuntu-vnc-xfce --skip echo $BASH_VERSION 
...
-d, --debug     Executes the vnc startup and tails the vnc/noVNC logs. 
                ...
                example: docker run -it -P --rm nishh2609/ubuntu-vnc-xfce --debug 
...
-h, --help      Prints out this help. 
                ...
                example: docker run --rm nishh2609/ubuntu-vnc-xfce 
